...
const Projects = () => {
    ...
    return (
        <div className='project-container'>
                    ...
                    <>
                        ...
                        {activeVideo === 'grocery' && (
                            <div className='video-container'>
                                ...
                                <p className='click-instruction'>CLICK on the video to go back</p>
                            </div>
                        )}
                    </>
                )}
                    ...
                    <>
                        ...
                        {activeVideo === 'flavourfinder' && (
                            <div className='flavour-finder-video'>
                                ...
                                <p>Link to the Recipe Generator! <a href='https://flavour-finder.onrender.com/' target='_blank' rel="noopener noreferrer">Click here!</a></p>
                                <p className='click-instruction'>CLICK on the video to go back</p>
                            </div>
                        )}
                    </>
            ...
            {activeVideo !== 'grocery' && activeVideo !== 'kanban' && activeVideo !== 'flavourfinder' && activeVideo !== 'react-blog' && (
